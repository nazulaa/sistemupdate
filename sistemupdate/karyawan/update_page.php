...
if ($id > 0) {
    ...
    if (empty($bukti_gambar)) {
        $bukti_gambar = $bukti_gambar_lama;
    }
...
<div class="row mb-3 align-items-end">
    ...
    <div class="col-md-4">
        <label for="searchTanggalPenugasan">Cari berdasarkan Tanggal :</label>
...
<div class="table-responsive">
    ...
    <div class="modal fade" id="modalUpdate" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <form action="update_page.php" method="POST" enctype="multipart/form-data" class="modal-content">
