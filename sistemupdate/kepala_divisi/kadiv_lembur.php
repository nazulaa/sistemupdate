...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $jam_lembur = $conn->real_escape_string($jam_lembur);

    $sql = "INSERT INTO lembur (nama, role, divisi, tanggal, keterangan, jam_mulai, jam_lembur) VALUES ('$nama', '$role', '$divisi', '$tanggal', '$keterangan', '$jam_mulai', '$jam_lembur')";

    if ($conn->query($sql) === TRUE) {
        $message = "Pengajuan lembur berhasil dilakukan!";
    } else {
        $message = "Gagal melakukan pengajuan lembur: " . $conn->error;
    }
}
...
<nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
            <a class="nav-link active" href="kepala_divisi.php"><i class="fa-solid fa-house"></i><span> Presensi</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="update_page_kadiv.php"><i class="fa-solid fa-bars-progress"></i><span> Progress</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="kadiv_add.php"><i class="fa-solid fa-file-pen"></i> <span> Tugas</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="kadiv_izin.php"><i class="fa-solid fa-notes-medical"></i><span> Izin</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="kadiv_lembur.php"><i class="fa-solid fa-users"></i> <span> Lembur</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="kadiv_view_resi.php"><i class="fa-solid fa-receipt"></i> <span> Resi</span></a>
        </li>
    ...
    <main class="p-4" id="main-content">
        ...
        <section>
            <h2 class="mb-4"><i class="fa-solid fa-file-alt"></i> Form Pengajuan Lembur</h2>
            <form method="POST" action="">
                ...
                <div class="mb-3">
                    <label for="jam_mulai" class="form-label"><i class="fa-solid fa-clock"></i> Jam Mulai</label>
                    <input type="time" class="form-control" id="jam_mulai" name="jam_mulai" required>
                </div>
                <div class="mb-3">
                    <label for="jam_lembur" class="form-label"><i class="fa-solid fa-clock"></i> Jam Lembur</label>
                    <input type="time" class="form-control" id="jam_lembur" name="jam_lembur" required>
                </div>
                <div class="mb-3">
